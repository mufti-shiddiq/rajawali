...
<div class="row">
    ...
    <div class="col-md-3">
        ...
        <div class="small-box bg-success">
            ...
            <a class="small-box-footer">
                Bulan Lalu {{"Rp " . number_format($totalValueTrxLm,0,".",".")}}
                <!-- <i class="fas fa-info-circle"></i> -->
            </a>
        </div>
    ...
    <div class="col-md-3">
        ...
        <div class="small-box bg-warning">
            ...
            <a class="small-box-footer">
                Bulan Lalu {{$countTotalProductLm}}
                <!-- <i class="fas fa-info-circle"></i> -->
            </a>
        </div>
    ...
    <div class="col-md-3">
        ...
        <div class="small-box bg-danger">
            ...
            <a class="small-box-footer">
                Bulan Lalu {{"Rp " . number_format($profitLm,0,".",".")}}
                <!-- <i class="fas fa-info-circle"></i> -->
            </a>
        </div>
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="card card-primary shadow">
            <div class="card-header">
                <h3 class="card-title">Nilai Transaksi dan Profit Bulanan</h3>
            </div>
            <div class="card-body">
                <div class="chart">

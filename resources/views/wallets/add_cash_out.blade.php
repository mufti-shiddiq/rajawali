                ...
                <div class="card-body">
                    <div class="form-row">
                        <div class="col">
                            ...
                            <div class="form-group">
                                <label for="cash_out">Nominal <a class="text-danger">*</a></label>
                                <input value="{{old('cash_out')}}" class="form-control {{$errors->first('cash_out') ? "is-invalid": ""}}" type="number" name="cash_out" id="cash_out" />
                                <div class="invalid-feedback">
